...
feval0_(fint *nobj, real *x)
{
  ...
  /***  objective ***/
	...
	v[2] += x[0];
	v[3] = 0.30168366087320725 * x[2];
	v[2] += v[3];
	v[3] = 0.1657019747951281 * x[3];
	v[2] += v[3];
	v[3] = 0.09101303123786032 * x[4];
	v[2] += v[3];
	v[3] = 0.04998957837011417 * x[5];
	v[2] += v[3];
	v[3] = 0.549257372161 * x[7];
	v[1] = -v[3];
	v[3] = exp(v[1]);
	if (errno) in_trouble("exp",v[1]);
	v[1] = x[6] * v[3];
