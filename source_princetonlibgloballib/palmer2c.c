...
feval0_(fint *nobj, real *x)
{
  ...
  /***  objective ***/
	...
	v[1] += x[0];
	v[2] = 0.771445096596542 * x[2];
	v[1] += v[2];
	v[2] = 0.6775752506671942 * x[3];
	v[1] += v[2];
	v[2] = 0.595127537062848 * x[4];
	v[1] += v[2];
	v[2] = 0.5227121047023797 * x[5];
	v[1] += v[2];
	v[2] = 0.45910822031671095 * x[6];
	v[1] += v[2];
	v[2] = 0.40324369010430916 * x[7];
	v[1] += v[2];
	v[2] = -v[1];
	v[1] = v[2] * v[2];
	v[0] += v[1];
	...
	v[2] += v[1];
	v[1] = 0.45910822031671095 * x[6];
	v[2] += v[1];
	v[1] = 0.40324369010430916 * x[7];
	v[2] += v[1];
	v[1] = -v[2];
	v[2] = v[1] * v[1];
	v[0] += v[2];
